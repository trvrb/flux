...
\begin{table}[h]
	...
	Model	&	Data		&	Dimen 	& Location prior	& 	Serum effects 	&	Virus avidities	& 	A/H3N2	& 	A/H1N1	& 	B/Vic	& 	B/Yam	\\
	\hline	
...
Additionally, we include and estimate `virus avidities' in an analogous fashion, which are intended to represent differences in overall HI reactivity between viruses.
...
We find that including virus avidities further improves test error, either alone with fixed serum effects (model 9, Table \ref{errortable}) or combined with estimating serum effects (model 10, Table \ref{errortable}).
With fixed serum effects, the inclusion of virus avidities results in improvements of between 0.02 and 0.09 log$_2$ HI titers and with estimated serum effects, the inclusion of virus avidities results in improvements of between 0.01 and 0.05 log$_2$ HI titers.
...
MCMC was used to sample virus locations $\viruses$, serum locations $\sera$, virus avidities $\ves$, serum effects $\ses$, MDS precision $1/\mdssd^2$, antigenic drift rate $\drift$, virus location precision $1/\virussd^2$, serum location precision $1/\serumsd^2$ and phylogenetic tree $\tree$.
