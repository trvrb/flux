...
We begin with Bayesian analogs of the models used by Smith et al.\ \cite{Smith04}, in which viruses and sera are represented as $N$-dimensional locations.
In this case, `serum effects' are fixed to the maximum titers exhibited by particular ferret sera, and virus and serum locations follow an uninformative diffuse normal prior as described in the `Antigenic cartography' section of Materials and methods.
...
\begin{table}[h]
	...
	9		&	2D 		& Diffusion/Drift	&	Fixed 			&	Estimated		&	0.80	&	0.72	&	0.69	&	0.75	\\		
	10		&	2D 		& Diffusion/Drift	&	Estimated		&	Estimated		&	0.76	&	0.71 	&	0.64	&	0.72	\\
	\hline
	\end{tabular}	
	}
\end{table}
