...
\begin{table}[h]
	...
	Model	&	Data		&	Dimen 	& Location prior	& 	Serum effects 	&	Virus effects	& 	A/H3N2	& 	A/H1N1	& 	B/Vic	& 	B/Yam	\\
	\hline	
...
These effects determine the baseline expectation of titer when virus and serum have identical antigenic locations.
We find that including these effects decreases test error further, resulting in comparable improvements from estimating virus and serum effects individually and giving an improvement of between 0.03 to 0.13 log$_2$ HI titers when estimating both virus and serum effects together (models 8--10; Table \ref{errortable}).
...
Influenza A/H3N2 has characteristically spindly tree showing rapid turnover of the virus population, while A/H1N1 and B have trees that show greater degrees of viral coexistance (Figure~\ref{trees}).
...
Here, we see that $N_e \tau$ broadly correlates with the rate of antigenic drift with A/H3N2 showing fast drift and reduced effective population size (Figure~\ref{trees}), as expected from basic epidemiological models \cite{Bedford12}.
...
The immunological basis of between-clade interference are not entirely clear, however cytotoxic T cells (CTLs) \cite{Voeten00}, antibodies that broadly neutralize HA \cite{Corti10} and antibodies to internal proteins \cite{Laidlaw13} have been hypothesized as possible mechanisms.
...
Incidence data used in this analysis is archived with Dryad (doi:10.5061/dryad.rc515).
