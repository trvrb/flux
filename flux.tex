...
We found no significant correlation when combining data across lineages (Figure~\ref{counts_corr}, Pearson's $r = -0.01$).
We testing significance following the same bootstrap procedure we used to assess the correlation between drift and incidence, finding a $p$-value of 0.514.
...
The finding of that antigenically advancement correlates with subsequent increased incidence within a lineage suggests a causal role for antigenic drift driving influenza incidence patterns.
The correlation between incidence and drift further suggests the possibility of aiding prediction at the start of an influenza of which lineage will predominate.
