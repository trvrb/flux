...
We find that influenza A/H3N2 evolved along antigenic dimension 1 at an estimated rate of 1.01 antigenic units per year (Figure~\ref{drift}, Table~\ref{drifttable}).
...
We find that other clades of influenza evolved in antigenic phenotype substantially slower than A/H3N2 (Figure~\ref{drift}, Table~\ref{paramtable}).
...
Interestingly, although we observe significantly different drift rates between lineages, we observe less variation in diffusion volatility (Table~\ref{paramtable}).
