...
\begin{figure}[h]
	\centering		
	\includegraphics[width=0.55\textwidth]{figures/jumps}
...
Correlation is present to greater of lesser degrees for each of the four clades, with $r_\mathrm{H3} = 0.63$, $r_\mathrm{H1} = 0.20$, $r_\mathrm{Vic} = 0.74$ and $r_\mathrm{Yam} = 0.58$.
