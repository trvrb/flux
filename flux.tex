...
Influenza viruses continually evolve in antigenic phenotype to escape human immunity.
In this study, we develop a new method to characterize influenza antigenic phenotype from immunological and genetic data.
We use this method to assess patterns of antigenic evolution in four different influenza viruses and show that antigenic drift strongly influences viral success.
Drifted viruses cause larger seasonal outbreaks and outcompete less evolved viruses.
A more thorough understanding of the predictors of viral success may allow selection of vaccine strains better matched to the population of influenza viruses circulating when the vaccine is deployed.
...
We find strong correspondence between our results and previous results by Smith et al.\ \cite{Smith04}, with equivalent models producing globally consistent antigenic maps and other models producing locally consistent maps with a small degree of global inconsistency (see Supp.\ Discussion).
...
Because of the threshold of sensitivity of the HI assay, it's difficult to distinguish a linear trajectory in 2D antigenic space from a slightly curved trajectory (see Supp.\ Discussion).
...
We compiled an antigenic dataset of hemagglutination inhibition (HI) measurements of virus isolates against post-infection ferret sera for influenza A/H3N2 by collecting data from previous publications and WHO vaccine strain selection reports (see Supp.\ Methods).
...
However, without drift parameter $\beta$, maps for A/H3N2 showed some degree of metastability, where some chains would converge on one solution and other chains would converge on a different solution (see Supp.\ Discussion).
...
For example, in A/H3N2 the HK/68, EN/72 and VI/75 clusters may rotate in relation to other clusters (see Supp.\ Discussion).
