...
Through comparison with epidemiological data, we show that antigenic drift influences overall incidence across lineages, and demonstrate a year-to-year correlation between drift and incidence.
...
We investigated the rates of antigenic evolution in A/H3N2, A/H1N1, B/Vic and B/Yam from 2000 to 2011, finding a general correspondence between antigenic drift in dimension 1 and incidence within the USA for each influenza clade.
We take the estimates of the rate of antigenic drift from the preceding section and compare these rates to a measurements of relative incidence for each influenza clade calculated from proportion of influenza isolations attributable to each clade (see Methods).
We analyze incidence from the 1998/1999 to the 2008/2009 seasons to avoid interactions with the 2009 H1N1 pandemic, finding that A/H3N2 accounted for 56\%, A/H1N1 for 20\%, B/Vic for 10\% and B/Yam for 14\% of influenza isolations during this time period.
We find a significant correlation between rate of antigenic drift and relative incidence across the four clades with $r=0.96$ (Pearson correlation, $p = 0.021$).
...
\begin{table}[h]
	\centering
	\caption{\textbf{Estimates of regression coefficients for the relationship of clade-specific USA incidence to antigenic drift within and across clades, where standardized incidence in A/H3N2 is predicted by $\beta_\mathrm{within} \times \mathrm{drift}_\mathrm{H3}$ + $\beta_\mathrm{sister} \times \mathrm{drift}_\mathrm{H1}$ + $\beta_\mathrm{across} \times \mathrm{drift}_\mathrm{Vic}$ + $\beta_\mathrm{across} \times \mathrm{drift}_\mathrm{Yam}$ and standardized incidence in other clades follows an analogous relationship.}}
	\label{interferencetable}	
	\begin{tabular}{ c c c c } 
	\hline
	Parameter				&	Estimate	&	Standard error 	& 	$p$-value \\
	\hline		
	$\beta_\mathrm{within}$	&	$1.19$		&	0.22			&	$2.5 \times 10^{-6}$ \\
	$\beta_\mathrm{sister}$	&	$-0.67$		&	0.22			&	$0.004$ \\
	$\beta_\mathrm{across}$	&	$-0.42$		&	0.16			&	$0.011$ \\
	\hline
	\end{tabular}
\end{table}
...
In the evolutionary Brownian process, the tips of the phylogeny $\tree$ correspond to the set of virus locations $(\virus_1, \ldots, \virus_\vn)$, and the probability of observing tip locations depends on the locations of internal nodes $(\virus_{n+1}, \ldots, \virus_{2\vn-2})$ and on the location of the root node $\virus_0$.
...
The root virus location $\virus_0$ is assumed to follow a normal distribution with expectation $(\beta \, t_0, 0)^{\prime}$ for $P=2$ and variance determined by the diffusion volatility $\virussd$ \cite{Lemey10}.
...
\begin{figure}[H]
	...
	(A) Incidence within a clade compared to antigenic drift within the same clade.
	...
	(B) Incidence within a clade compared to antigenic drift in sister clades.
	For example, incidence of A/H3N2 in season 1998/1999 is measured against year-to-year antigenic drift of A/H1N1 from 1997 to 1998, and incidence of B/Vic in 1998/1999 is measured against antigenic drift of B/Yam from 1997 to 1998.
	(B) Incidence within a clade compared to antigenic drift in non-type clades.
	For example, incidence of A/H3N2 in season 1998/1999 is measured against year-to-year antigenic drift of B/Vic + B/Yam from 1997 to 1998, and incidence of B/Vic in 1998/1999 is measured against antigenic drift of A/H3N2  A/H1N1 from 1997 to 1998.
	Incidence is measured as yearly ILI percentage multipled by proportion of virus isolations of a particular clade.
