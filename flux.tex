...
It is interesting that this phenomenon occurs despite the fact that antigenic drift is accomplished, not by steady movement of the entire virus population, but by the successive emergence of drifted variants that each come to take over the virus population.
...
We fit a linear model that predicts standardized incidence based upon drift within a clade, drift in other clades of same type, and drift in clades of differing type (Table~\ref{interferencetable}).
