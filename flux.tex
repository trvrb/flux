...
Using HI data for influenza A/H3N2, A/H1N1, B/Victoria and B/Yamagata, we determine average rates of antigenic drift for each lineage, as well as year-to-year variability in the rate of drift.
...
In the case of influenza B, B/Vic and B/Yam refer to antigenically distinct lineages which diverged from a single lineage prior to 1980 \cite{Rota90}.
...
%% AR - Figure improvements: Give proper axis labels. Label clusters (Texas/77, Beijing/89, Beijing/92, Wuhan/95, Sydney/97 that are referenced in the text)
\begin{figure}[h]
	\centering		
	...
	Positioning of lineages, e.g.\ A/H3N2 and A/H1N1, relative to each other is arbitrary.
...
%% AR - Figure improvements: Give proper axis labels. Label clusters (Texas/77, Beijing/89, Beijing/92, Sydney/97 that are referenced in the text)
\begin{figure}[h]
	\centering		
