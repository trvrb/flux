...
or \\
Cartographic characterization of the antigenic, evolutionary and competitive dynamics of seasonal influenza viruses \\
or \\
Integrating antigenic dynamics with molecular evolution to characterize competition within and between seasonal influenza lineages \\
}
...
We find that this 2D model performs well, yielding an average absolute predictive error of between XXX and XXX log$_2$ HI titers across influenza lineages (model 2; Table \ref{errortable}).
...
\begin{table}[h]
	...
	\hline	
	1		&	1D 		&	Fixed 			&	None			& Uninformed		&	X 		&	0.94 	&	0.90	&	1.08	\\
	2		&	2D 		&	Fixed 			&	None			& Uninformed		&	X 		&	0.78 	&	0.82	&	0.90	\\
	3		&	3D 		&	Fixed 			&	None			& Uninformed		&	X 		&	0.80 	&	0.85	&	0.92	\\
	4		&	4D 		&	Fixed 			&	None			& Uninformed		&	X 		&	0.84 	&	0.90	&	0.97	\\	
	5		&	5D 		&	Fixed 			&	None			& Uninformed		&	X 		&	X 		&	0.98	&	1.04	\\	
	6		&	2D 		&	Estimated 		&	Estimated		& Uninformed		&	X 		&	X 		&	X		&	X		\\
...
We find that including these effects decreases test error further, ranging in improvement from XXX to XXX (model 6; Table \ref{errortable}).
We further extend this model to include a time-informed prior that models the process of antigenic drift, in which virus and serum locations along dimension 1 increase with date of virus or serum sampling, resulting in a small improvement in predictive error (model 7; Table \ref{errortable}).
