...
In all cases when drift parameter $\beta$ was included the MCMC chain mixed well and arrived at the same posterior distribution from different starting points.
