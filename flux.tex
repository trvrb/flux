...
Combining observations of year-to-year drift vs seasonal incidence across all four lineages, yields a simple linear model where one unit of antigenic drift results in an increase of 0.8\% in lineage-specific ILI.
