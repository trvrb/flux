...
Original reviewer criticisms are in plain text.  Our responses follow in \textbf{bold}.  A detailed list of every criticism and exactly what was revised in the manuscript in response to this criticism is available at \url{https://github.com/trvrb/flux/issues?state=closed}.
